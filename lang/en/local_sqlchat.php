...
$string['result:history'] = 'Your recent questions';

$string['history:empty'] = 'No history yet. Generate a query and it will appear here.';
$string['history:load'] = 'Load SQL';
$string['history:when'] = 'When';
...
$string['privacy:metadata:log:success'] = 'Whether the query generated and executed successfully.';
$string['privacy:metadata:log:errormsg'] = 'Any error message from generation or execution.';
$string['privacy:metadata:log:rowsreturned'] = 'The number of rows the query returned.';
$string['privacy:metadata:log:tokensused'] = 'The number of AI tokens the generation consumed.';
$string['privacy:metadata:log:latencyms'] = 'How long the query took, in milliseconds.';
